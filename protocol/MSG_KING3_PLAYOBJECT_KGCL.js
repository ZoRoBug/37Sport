...
$root.MSG_KING3_PLAYOBJECT_KGCL = (function() {

    /**
     * Properties of a MSG_KING3_PLAYOBJECT_KGCL.
     * @exports IMSG_KING3_PLAYOBJECT_KGCL
     * @interface IMSG_KING3_PLAYOBJECT_KGCL
     * @property {number} msgID MSG_KING3_PLAYOBJECT_KGCL msgID
     * @property {number|null} [rid] MSG_KING3_PLAYOBJECT_KGCL rid
     * @property {number|null} [round] MSG_KING3_PLAYOBJECT_KGCL round
     * @property {number|null} [pid] MSG_KING3_PLAYOBJECT_KGCL pid
     * @property {King3Object|null} [object] MSG_KING3_PLAYOBJECT_KGCL object
     * @property {MSG_KING3_PLAYOBJECT_KGCL.Result|null} [result] MSG_KING3_PLAYOBJECT_KGCL result
     */

    /**
     * Constructs a new MSG_KING3_PLAYOBJECT_KGCL.
     * @exports MSG_KING3_PLAYOBJECT_KGCL
     * @classdesc Represents a MSG_KING3_PLAYOBJECT_KGCL.
     * @implements IMSG_KING3_PLAYOBJECT_KGCL
     * @constructor
     * @param {IMSG_KING3_PLAYOBJECT_KGCL=} [properties] Properties to set
     */
    function MSG_KING3_PLAYOBJECT_KGCL(properties) {
        if (properties)
    ...
    /**
     * MSG_KING3_PLAYOBJECT_KGCL msgID.
     * @member {number} msgID
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @instance
     */
    MSG_KING3_PLAYOBJECT_KGCL.prototype.msgID = 0;

    /**
     * MSG_KING3_PLAYOBJECT_KGCL rid.
     * @member {number} rid
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @instance
     */
    MSG_KING3_PLAYOBJECT_KGCL.prototype.rid = 0;

    /**
     * MSG_KING3_PLAYOBJECT_KGCL round.
     * @member {number} round
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @instance
     */
    MSG_KING3_PLAYOBJECT_KGCL.prototype.round = 0;

    /**
     * MSG_KING3_PLAYOBJECT_KGCL pid.
     * @member {number} pid
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @instance
     */
    MSG_KING3_PLAYOBJECT_KGCL.prototype.pid = 0;

    /**
     * MSG_KING3_PLAYOBJECT_KGCL object.
     * @member {King3Object} object
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @instance
     */
    MSG_KING3_PLAYOBJECT_KGCL.prototype.object = 0;

    /**
     * MSG_KING3_PLAYOBJECT_KGCL result.
     * @member {MSG_KING3_PLAYOBJECT_KGCL.Result} result
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @instance
     */
    MSG_KING3_PLAYOBJECT_KGCL.prototype.result = 0;

    /**
     * Creates a new MSG_KING3_PLAYOBJECT_KGCL instance using the specified properties.
     * @function create
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @static
     * @param {IMSG_KING3_PLAYOBJECT_KGCL=} [properties] Properties to set
     * @returns {MSG_KING3_PLAYOBJECT_KGCL} MSG_KING3_PLAYOBJECT_KGCL instance
     */
    MSG_KING3_PLAYOBJECT_KGCL.create = function create(properties) {
        return new MSG_KING3_PLAYOBJECT_KGCL(properties);
    };

    /**
     * Encodes the specified MSG_KING3_PLAYOBJECT_KGCL message. Does not implicitly {@link MSG_KING3_PLAYOBJECT_KGCL.verify|verify} messages.
     * @function encode
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @static
     * @param {IMSG_KING3_PLAYOBJECT_KGCL} message MSG_KING3_PLAYOBJECT_KGCL message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    MSG_KING3_PLAYOBJECT_KGCL.encode = function encode(message, writer) {
        if (!writer)
        ...
        if (message.object != null && message.hasOwnProperty("object"))
            writer.uint32(/* id 5, wireType 0 =*/40).int32(message.object);
    ...
    /**
     * Encodes the specified MSG_KING3_PLAYOBJECT_KGCL message, length delimited. Does not implicitly {@link MSG_KING3_PLAYOBJECT_KGCL.verify|verify} messages.
     ...
     * @returns {$protobuf.Writer} Writer
     */
    MSG_KING3_PLAYOBJECT_KGCL.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a MSG_KING3_PLAYOBJECT_KGCL message from the specified reader or buffer.
     * @function decode
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {MSG_KING3_PLAYOBJECT_KGCL} MSG_KING3_PLAYOBJECT_KGCL
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_KING3_PLAYOBJECT_KGCL.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_KING3_PLAYOBJECT_KGCL();
    ...
    /**
     * Decodes a MSG_KING3_PLAYOBJECT_KGCL message from the specified reader or buffer, length delimited.
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_KING3_PLAYOBJECT_KGCL.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
    ...
    /**
     * Verifies a MSG_KING3_PLAYOBJECT_KGCL message.
     * @function verify
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @static
     ...
     */
    MSG_KING3_PLAYOBJECT_KGCL.verify = function verify(message) {
        ...
        if (message.object != null && message.hasOwnProperty("object"))
            ...
            default:
                return "object: enum value expected";
            case 0:
            case 1:
            case 2:
            case 3:
    ...
    /**
     * Creates a MSG_KING3_PLAYOBJECT_KGCL message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @static
     ...
     * @returns {MSG_KING3_PLAYOBJECT_KGCL} MSG_KING3_PLAYOBJECT_KGCL
     */
    MSG_KING3_PLAYOBJECT_KGCL.fromObject = function fromObject(object) {
        if (object instanceof $root.MSG_KING3_PLAYOBJECT_KGCL)
            return object;
        var message = new $root.MSG_KING3_PLAYOBJECT_KGCL();
    ...
    /**
     * Creates a plain object from a MSG_KING3_PLAYOBJECT_KGCL message. Also converts values to other types if specified.
     * @function toObject
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @static
     * @param {MSG_KING3_PLAYOBJECT_KGCL} message MSG_KING3_PLAYOBJECT_KGCL
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    MSG_KING3_PLAYOBJECT_KGCL.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
            ...
            object.round = 0;
            object.pid = 0;
            object.object = options.enums === String ? "MIN" : 0;
        ...
        if (message.object != null && message.hasOwnProperty("object"))
            object.object = options.enums === String ? $root.King3Object[message.object] : message.object;
        if (message.result != null && message.hasOwnProperty("result"))
            object.result = options.enums === String ? $root.MSG_KING3_PLAYOBJECT_KGCL.Result[message.result] : message.result;
        return object;
    };

    /**
     * Converts this MSG_KING3_PLAYOBJECT_KGCL to JSON.
     * @function toJSON
     * @memberof MSG_KING3_PLAYOBJECT_KGCL
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    MSG_KING3_PLAYOBJECT_KGCL.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    /**
     * Result enum.
     * @name MSG_KING3_PLAYOBJECT_KGCL.Result
     * @enum {string}
     ...
     * @property {number} OBJECT_ERROR=4 OBJECT_ERROR value
     * @property {number} NO_PLAYER=5 NO_PLAYER value
     * @property {number} NO_THIS_ROOM=6 NO_THIS_ROOM value
     * @property {number} ROUND_ERROR=7 ROUND_ERROR value
     */
    MSG_KING3_PLAYOBJECT_KGCL.Result = (function() {
        var valuesById = {}, values = Object.create(valuesById);
        values[valuesById[0] = "SUCCESS"] = 0;
        values[valuesById[1] = "OFFLINE"] = 1;
        values[valuesById[2] = "NO_CLIENT_INFO"] = 2;
        values[valuesById[3] = "NO_STARTING"] = 3;
        values[valuesById[4] = "OBJECT_ERROR"] = 4;
        values[valuesById[5] = "NO_PLAYER"] = 5;
        values[valuesById[6] = "NO_THIS_ROOM"] = 6;
        values[valuesById[7] = "ROUND_ERROR"] = 7;
        return values;
    })();

    return MSG_KING3_PLAYOBJECT_KGCL;
})();
