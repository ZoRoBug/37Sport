...
$root.MSG_PLAYER_REGISTER_CLDB = (function() {

    /**
     * Properties of a MSG_PLAYER_REGISTER_CLDB.
     * @exports IMSG_PLAYER_REGISTER_CLDB
     * @interface IMSG_PLAYER_REGISTER_CLDB
     * @property {number} msgID MSG_PLAYER_REGISTER_CLDB msgID
     * @property {string|null} [nickname] MSG_PLAYER_REGISTER_CLDB nickname
     * @property {string|null} [password] MSG_PLAYER_REGISTER_CLDB password
     * @property {Platform|null} [platform] MSG_PLAYER_REGISTER_CLDB platform
     * @property {number|null} [loginID] MSG_PLAYER_REGISTER_CLDB loginID
     */

    /**
     * Constructs a new MSG_PLAYER_REGISTER_CLDB.
     * @exports MSG_PLAYER_REGISTER_CLDB
     * @classdesc Represents a MSG_PLAYER_REGISTER_CLDB.
     * @implements IMSG_PLAYER_REGISTER_CLDB
     * @constructor
     * @param {IMSG_PLAYER_REGISTER_CLDB=} [properties] Properties to set
     */
    function MSG_PLAYER_REGISTER_CLDB(properties) {
        if (properties)
    ...
    /**
     * MSG_PLAYER_REGISTER_CLDB msgID.
     * @member {number} msgID
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @instance
     */
    MSG_PLAYER_REGISTER_CLDB.prototype.msgID = 0;

    /**
     * MSG_PLAYER_REGISTER_CLDB nickname.
     * @member {string} nickname
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @instance
     */
    MSG_PLAYER_REGISTER_CLDB.prototype.nickname = "";

    /**
     * MSG_PLAYER_REGISTER_CLDB password.
     * @member {string} password
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @instance
     */
    MSG_PLAYER_REGISTER_CLDB.prototype.password = "";

    /**
     * MSG_PLAYER_REGISTER_CLDB platform.
     * @member {Platform} platform
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @instance
     */
    MSG_PLAYER_REGISTER_CLDB.prototype.platform = 0;

    /**
     * MSG_PLAYER_REGISTER_CLDB loginID.
     * @member {number} loginID
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @instance
     */
    MSG_PLAYER_REGISTER_CLDB.prototype.loginID = 0;

    /**
     * Creates a new MSG_PLAYER_REGISTER_CLDB instance using the specified properties.
     * @function create
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @static
     * @param {IMSG_PLAYER_REGISTER_CLDB=} [properties] Properties to set
     * @returns {MSG_PLAYER_REGISTER_CLDB} MSG_PLAYER_REGISTER_CLDB instance
     */
    MSG_PLAYER_REGISTER_CLDB.create = function create(properties) {
        return new MSG_PLAYER_REGISTER_CLDB(properties);
    };

    /**
     * Encodes the specified MSG_PLAYER_REGISTER_CLDB message. Does not implicitly {@link MSG_PLAYER_REGISTER_CLDB.verify|verify} messages.
     * @function encode
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @static
     * @param {IMSG_PLAYER_REGISTER_CLDB} message MSG_PLAYER_REGISTER_CLDB message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    MSG_PLAYER_REGISTER_CLDB.encode = function encode(message, writer) {
        if (!writer)
    ...
    /**
     * Encodes the specified MSG_PLAYER_REGISTER_CLDB message, length delimited. Does not implicitly {@link MSG_PLAYER_REGISTER_CLDB.verify|verify} messages.
     ...
     * @returns {$protobuf.Writer} Writer
     */
    MSG_PLAYER_REGISTER_CLDB.encodeDelimited = function encodeDelimited(message, writer) {
        return this.encode(message, writer).ldelim();
    };

    /**
     * Decodes a MSG_PLAYER_REGISTER_CLDB message from the specified reader or buffer.
     * @function decode
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @static
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {MSG_PLAYER_REGISTER_CLDB} MSG_PLAYER_REGISTER_CLDB
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_PLAYER_REGISTER_CLDB.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.MSG_PLAYER_REGISTER_CLDB();
    ...
    /**
     * Decodes a MSG_PLAYER_REGISTER_CLDB message from the specified reader or buffer, length delimited.
     ...
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    MSG_PLAYER_REGISTER_CLDB.decodeDelimited = function decodeDelimited(reader) {
        if (!(reader instanceof $Reader))
    ...
    /**
     * Verifies a MSG_PLAYER_REGISTER_CLDB message.
     * @function verify
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @static
     ...
     */
    MSG_PLAYER_REGISTER_CLDB.verify = function verify(message) {
    ...
    /**
     * Creates a MSG_PLAYER_REGISTER_CLDB message from a plain object. Also converts values to their respective internal types.
     * @function fromObject
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @static
     ...
     * @returns {MSG_PLAYER_REGISTER_CLDB} MSG_PLAYER_REGISTER_CLDB
     */
    MSG_PLAYER_REGISTER_CLDB.fromObject = function fromObject(object) {
        if (object instanceof $root.MSG_PLAYER_REGISTER_CLDB)
            return object;
        var message = new $root.MSG_PLAYER_REGISTER_CLDB();
    ...
    /**
     * Creates a plain object from a MSG_PLAYER_REGISTER_CLDB message. Also converts values to other types if specified.
     * @function toObject
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @static
     * @param {MSG_PLAYER_REGISTER_CLDB} message MSG_PLAYER_REGISTER_CLDB
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    MSG_PLAYER_REGISTER_CLDB.toObject = function toObject(message, options) {
        if (!options)
            options = {};
        var object = {};
        if (options.defaults) {
    ...
    /**
     * Converts this MSG_PLAYER_REGISTER_CLDB to JSON.
     * @function toJSON
     * @memberof MSG_PLAYER_REGISTER_CLDB
     * @instance
     * @returns {Object.<string,*>} JSON object
     */
    MSG_PLAYER_REGISTER_CLDB.prototype.toJSON = function toJSON() {
        return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
    };

    return MSG_PLAYER_REGISTER_CLDB;
})();
