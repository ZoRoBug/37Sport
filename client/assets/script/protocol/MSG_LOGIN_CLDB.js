...
$root.MSG_LOGIN_CLDB = (function() {
     ...
     * @property {number|null} [loginID] MSG_LOGIN_CLDB loginID
     * @property {string|null} [ip] MSG_LOGIN_CLDB ip
     */
     ...
     * @instance
     */
    MSG_LOGIN_CLDB.prototype.loginID = 0;
    ...
    MSG_LOGIN_CLDB.encode = function encode(message, writer) {
        ...
        if (message.wxCode != null && message.hasOwnProperty("wxCode"))
            writer.uint32(/* id 7, wireType 2 =*/58).string(message.wxCode);
        if (message.wxSessionKey != null && message.hasOwnProperty("wxSessionKey"))
            writer.uint32(/* id 8, wireType 2 =*/66).string(message.wxSessionKey);
        if (message.loginID != null && message.hasOwnProperty("loginID"))
            writer.uint32(/* id 9, wireType 1 =*/73).double(message.loginID);
