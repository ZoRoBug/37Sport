...
$root.MSG_REFUND_GMCL = (function() {
     ...
     * @property {number|null} [coin] MSG_REFUND_GMCL coin
     * @property {number|null} [subcoin] MSG_REFUND_GMCL subcoin
     */
     ...
     * @instance
     */
    MSG_REFUND_GMCL.prototype.coin = 0;

    /**
     * MSG_REFUND_GMCL subcoin.
     * @member {number} subcoin
     * @memberof MSG_REFUND_GMCL
     * @instance
     */
    MSG_REFUND_GMCL.prototype.subcoin = 0;
    ...
    MSG_REFUND_GMCL.encode = function encode(message, writer) {
        ...
        if (message.subcoin != null && message.hasOwnProperty("subcoin"))
            writer.uint32(/* id 5, wireType 1 =*/41).double(message.subcoin);
        return writer;
    };
