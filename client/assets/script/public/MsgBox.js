...
function DoShow(prefab, owner, tips, type, callback, options) {
    ...
    if (!bgWidth) bgWidth = width * 0.8;
    if (!bgHeight) bgHeight = bgWidth / 1.8;
...
const msgbox = {
    ...
    ShopMsgBox: function (tips) {
        let options = new Array();
        options[g_msgbox.BT_NO] = '确定';
        options[g_msgbox.BT_YES] = '去充值';
        this.Show(null, tips, g_msgbox.MB_YESNO, function (result) {
